    ...
    public partial class RelEntrada : Form
    {
        ...
        private void btBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (cmbGrupo.Text == "Todos" && cmbTipoConta.Text == "Todos")
            {
                ...
                comi.Parameters.Add("@Evento", MySqlDbType.VarChar, 45).Value = "Entrada";
            ...
            MySqlDataAdapter DtaEntrada = new MySqlDataAdapter(comi);
            ...
            if (count >= 1)
            {
                ...
                DtaEntrada.Fill(DtEntrada);
                dgvFinanceiro.DataSource = DtEntrada;
                dgvFinanceiro.Columns[0].Visible = false;
                lbCountReg.Text = dgvFinanceiro.Rows.Count + " Registros Encontrados!";
                lbValor.Text = "Total de Entradas: R$ " + valor.ToString("n2");
            ...
            else
            {
                ...
                lbCountReg.Text = dgvFinanceiro.Rows.Count + " Registros Encontrados!";
                lbValor.Text = "Total de Entradas: R$ " + 0.00.ToString("n2");
            }
